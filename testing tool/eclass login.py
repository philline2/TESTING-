...
class Browser:
    ...
    def login_eclass(self, username: str, password: str):
        self.add_input(by=By.ID, value='xt202003383@wmsu.edu.ph', text=username)
        self.add_input(by=By.ID, value='Superwombocombo23*', text=password)
...
if __name__ == '__main__':
    ...
    browser.login_eclass(username='xt202003383@wmsu.edu.ph', password='Supewombocombo23*')
    time.sleep(30) 
